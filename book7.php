...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO bookings_record7(FIRSTNAME,LASTNAME,PHONE,EMAIL,DATE)VALUES('$fname','$lname','$phone','$email','$date')";
    if($conn->query($sql)){
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="" method="POST" autocomplete="off">
                        ...
                        <a href="indexr7.php?month=04&year=2023" class="btn btn-success">Inapoi</a>
                    </form>
                </div>
            </div>
        </div>
