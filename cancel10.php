...
if(isset($_POST['stud_delete_btn']))
{
    ...
    $query = "DELETE FROM bookings_record10 WHERE id='$id' ";
    $query_run = mysqli_query($con, $query);

    if($query_run)
    {
        echo  '<script>
        window.location.href = "cancel10.php";
            ...
            <div class="col-md-8">
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="cancel10.php" method="POST">
                            ...
                            <div class="froum-group mb-3">
                                ...
                                <a href="indexr10.php?month=05&year=2023" class="btn btn-danger">Inapoi</a>
                            </div>
                        </form>
