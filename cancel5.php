...
if(isset($_POST['stud_delete_btn']))
{
    ...
    $query = "DELETE FROM bookings_record5 WHERE id='$id' ";
    $query_run = mysqli_query($con, $query);

    if($query_run)
    {
        echo  '<script>
        window.location.href = "cancel5.php";
            ...
            <div class="col-md-8">
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="cancel5.php" method="POST">
                            ...
                            <div class="froum-group mb-3">
                                ...
                                <a href="indexr5.php?month=05&year=2023" class="btn btn-danger">Inapoi</a>
                            </div>
                        </form>
